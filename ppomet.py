...
#Building the model with 1 500 000 timesteps
    model = PPO("MultiInputPolicy", env, verbose=1, tensorboard_log="./ppo_crafter_tensorboard/", n_steps=2048)
...
#Computing achievement unlock rates
    ...
    for a in achievement_names:
        ...
        #Building an array of nonzero achievemtn rates
...
#Calculating the geometric mean of unlock rates
    ...
    #Calculating average metrics over all episodes
