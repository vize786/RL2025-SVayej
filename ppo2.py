...
#Reset function when starting a new episodes.
    def reset(self, *, seed=None, options=None):
        ...
        #Initialising the inventory and achievement vectors
        ...
        #Constructs an observation dictionary with three parts, the processed image observation, the zeroed inventory vector and the zero achievement vector.
        obs_dict = {
            "image": image,
...
#Updating the step function to include reward shaping
    def step(self, action):
        ...
        #Calculating an annealing factor which reduces shaped reqrads as training increases
        self.total_steps += 1
...
#Shaped reward for exploration (0.4)
...
#Shaped reward (0.8) for collecting new items
...
#Constructing observation dictionary
...
if __name__ == "__main__":
   #Setting the number of environments to 8
    n_envs = 8  
...
#Evaluating over 400 episodes
    ...
    for ep in range(n_eval_episodes):
        ...
        while not done[0]:
             ...
             # Calling the agents model to get the next action
