...
#Creating a wrapper function for the environment (which is inherited from gym.Env) so that it can be compatible woth libraries such as Stable Baselines3 and Gymnasium
